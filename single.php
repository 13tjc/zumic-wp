...
<style>
	...
	div.widget.clicky-popular-posts-widget .single-title {margin-right: -45px!important;}
	.geo-date {width: 85px!important;}
	.article-header {margin-bottom: -25px;}
	div.widget.clicky-popular-posts-widget {width: 219px!important;}
	.body-border {width: 102%!important;}
</style>
<?php get_header(); ?>
<?php
						...
						<div id="main" class="first clearfix" role="main">
							...
							<div class="body-border">
									<header class="article-header">
										<h1 class="page-title post-title entry-title"><?php the_title(); ?></h1>
										<?php bones_page_credits(); ?><br>
										 <br>
									</header>
									<?php the_content(); ?>							
...
<div class="hov">
	 <?php 
        ...
        ?>
	<a href="<?php echo $perma . "?sidebar-post"; ?>" title="<?php the_title_attribute(); ?>">
...
<br>
						...
						<div class="block-related clearfix sidebar">
							...
							<div class="news-mobile">
								...
								<div class="block-related-latest-news grid-4">
										<?php 
						 ...
						 <!-- <div class="zumic-a clearfix lastad" >
